...
public class OrderAssert extends AbstractObjectAssert<OrderAssert, Order> {
   ...
   */
  public OrderAssert hasCustomer(com.kagzz.jmix.rys.customer.entity.Customer customer) {
    // check that actual Order we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    com.kagzz.jmix.rys.customer.entity.Customer actualCustomer = actual.getCustomer();
